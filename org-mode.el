...
(setq org-capture-templates
	...
	("e" "Event" entry (file+headline "~/share/all/org-mode/misc.org" "Events")
	 "* %?\n:PROPERTIES:\n:CREATED: %U\n:END:\n\n" :empty-lines 1)
	("g" "GLT12" entry (file+headline "~/share/all/org-mode/misc.org" "GLT12")
	 "* %?\n:PROPERTIES:\n:CREATED: %U\n:END:\n\n" :empty-lines 1)
	("i" "IST Templates")
	...
	("m" "movie" entry (file+headline "~/share/all/org-mode/movies.org" "inbox")
	 "* TODO %?\n:PROPERTIES:\n:CREATED: %U\n:END:\n\n" :empty-lines 1)
	("x" "xlog")
	("xf" "xlog FNS" table-line (id "3ec5488b-6b66-49e1-b1a1-11e3e09fe354") "| %T |")
	("xz" "xlog ZNS" table-line (id "193caabf-626e-4873-b471-5f2018019001") "| %T |")
	("xh" "xlog hometrainer" table-line (id "xlog-hometrainer") "| %T |  |  |  |")
	("xb" "xlog bob" table-line (id "xlog-bob-Restguthaben") "| %T |  |  |  |  |")
